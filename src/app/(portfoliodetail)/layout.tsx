...
const LayoutPage = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="w-screen min-h-screen bg-background h-max flex flex-col items-center">
      {/* Top Bar */}
      <div className="w-full h-[100px] fixed top-0 left-0 z-10 bg-background/90 shadow-lg shadow-primary/80">
        <div className="max-w-7xl  mx-auto flex items-center justify-between h-full py-3 px-4">
          {/* Back Button */}
          
          <IconBackadminButton/>
          {/* Page Title */}
          <h1 className="text-3xl md:text-4xl text-primary font-semibold">Project Detail</h1>
